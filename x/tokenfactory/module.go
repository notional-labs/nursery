...
import (
	...
	"github.com/notional-labs/nursery/x/tokenfactory/client/cli"
	"github.com/notional-labs/nursery/x/tokenfactory/exported"
	"github.com/notional-labs/nursery/x/tokenfactory/keeper"
	simulation "github.com/notional-labs/nursery/x/tokenfactory/simulation"
...
// 	tfDefaultGen.Params.DenomCreationFee = sdk.NewCoins(sdk.NewCoin(appparams.BondDenom, math.NewInt(10000000)))
