...
import (
	...
	bindings "github.com/notional-labs/nursery/x/tokenfactory/bindings/types"
)
...
func queryCustom(t *testing.T, ctx sdk.Context, junoapp *app.WasmApp, contract sdk.AccAddress, request bindings.TokenQuery, response interface{}) {
