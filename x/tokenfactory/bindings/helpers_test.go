...
func FundAccount(t *testing.T, ctx sdk.Context, wasmapp *app.WasmApp, acct sdk.AccAddress) {
	err := banktestutil.FundAccount(ctx, wasmapp.BankKeeper, acct, sdk.NewCoins(
...
func storeReflectCode(t *testing.T, ctx sdk.Context, junoapp *app.WasmApp, addr sdk.AccAddress) uint64 {
...
func instantiateReflectContract(t *testing.T, ctx sdk.Context, junoapp *app.WasmApp, funder sdk.AccAddress) sdk.AccAddress {
	initMsgBz := []byte("{}")
	contractKeeper := keeper.NewDefaultPermissionKeeper(junoapp.WasmKeeper)
	codeID := uint64(1)
...
func fundAccount(t *testing.T, ctx sdk.Context, junoapp *app.WasmApp, addr sdk.AccAddress, coins sdk.Coins) {
